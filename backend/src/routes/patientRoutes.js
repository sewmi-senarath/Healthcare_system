...
router.post('/register', patientRegisterValidation, (req, res) => {
...
router.get('/profile', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.getPatientProfile(req, res);
});

router.put('/profile', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.updatePatientProfile(req, res);
});

router.get('/medical-records', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.viewMedicalRecords(req, res);
});

router.put('/medical-history', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.updateMedicalHistory(req, res);
});

router.put('/allergies', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.updateAllergies(req, res);
});

router.get('/dashboard/stats', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.getDashboardStats(req, res);
});

router.get('/dashboard/recent-activity', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.getRecentActivity(req, res);
});

router.get('/appointments', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.getPatientAppointments(req, res);
});

router.get('/notifications', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
  patientController.getPatientNotifications(req, res);
});

router.get('/search/:patientId', authenticateToken, (req, res) => {
  const patientController = container.get('patientController');
